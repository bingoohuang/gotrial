...
// from https://gitlab.com/searsaw/funwithconcurrency
...
func createHTTPServer(ctx context.Context, name, addr string, h http.HandlerFunc, wg *sync.WaitGroup) func() error {
	return func() error {
